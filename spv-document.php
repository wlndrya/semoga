								...
								<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover">
											...
											<?php
												...
												WHERE id_user_company = $user_id AND tb_internship.status_intern='YES'");
												...
												<tr>
													...
													<td><?php echo "<center>
													<a href = 'index.php?page=spv-detail-attendance&id=". $data['id_internship'] ."' type='button' class='btn py-2 my-auto mx-auto rounded btn-modify text-white'><i class='fas fa-eye'></i> View</a>
													</td></center>"?></td>
													<!-- <td>
													<center><?php
