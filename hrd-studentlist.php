										...
										<table id="add-row" class="display table table-striped table-hover">
											...
											<tbody>
												...
												while ($data = mysqli_fetch_array($view)) {
													...
													<td><center>
													<a href = '#' data-toggle = 'modal' type = 'button' title = 'Add Supervisor' class = 'btn btn-link btn-primary' data-original-title = 'Add Supervisor' data-target = '#modal-edit" . $data['id_internship'] . "'><i class='fa fa-edit fa-md'></i></a>
													</td></center>
													</tr>"
												?>
