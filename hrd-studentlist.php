	...
	<div class="wrapper horizontal-layout-2">
		...
		<div class="main-panel">
			<div class="container">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title"><b>LIST INTERNSHIP</b></h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
												...
												$view_student = mysqli_query($conn, "SELECT * FROM student_internship order by id_mhs asc");
												$no = 1;
												while ($data = mysqli_fetch_array($view_student)) {
													echo "<tr>
													<td>" . $data['id_mhs'] . "</td>
													<td>" . $data['name'] . "</td>
													...
													<td>
													<a href = '#' data-toggle = 'modal' type = 'button' title = 'Edit' class = 'btn btn-link btn-primary' data-original-title = 'Edit' data-target = ''><i class='fa fa-edit fa-md'></i></a>
													<a href = '#' data-toggle = 'modal' type = 'button' title = 'Delete' class = 'btn btn-link btn-danger' data-original-title = 'Delete' data-target = '#modaldelete$no'><i class='fa fa-times fa-lg'></i></a>
													</td>
													</tr>"
												?>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Are you sure to delete this student internship?
                                                                </div>
                                                                <form action="proses_dummy_test.php?PageAction=delete_student_company" method="post">
                                                                    <input type="hidden" name="id_student_internship" value="<?php echo $data['id_student_internship'] ?>">
            	...
            	<!-- Modal Add Student List -->
			<div class="modal fade" id="modaladd" tabindex="-1" role="dialog" aria-labelledby="modaladdspv" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered cascading-modal modal-lg" role="document">
				  <div class="modal-content">
					<div class="modal-header">
					  <h5 class="modal-title" id="modaladdspv">ADD STUDENT INTERNSHIP</h5>
					  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					  </button>
					</div>

					<form method="POST" action="proses_dummy_test.php?PageAction=add_student_company">
					<input type="hidden" id="token" name="token" value="<?php echo $token; ?>">
					  <div class="modal-body">
						<div class="form-group">
						  <label for="id_mhs">Student ID</label>
						  <input type="text" class="form-control" id="id_mhs" name="id_mhs" aria-describedby="id_mhs" placeholder="" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" id="studyprogram" placeholder="" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <select class="form-control" id="supervisor" name="supervisor">
                              <option></option>
							  <?php
							  $sql = mysqli_query($conn, "SELECT * FROM user_company ORDER BY id_user_company");
							  if(mysqli_num_rows($sql) != 0){
								  while($row = mysqli_fetch_assoc($sql)){
									  echo '<option>'.$row['user_fullname'].'</option>';
								  }
							  }
							  ?>
                            </select>
					  ...
					  <div class="modal-footer border-top-0 d-flex justify-content-center">
						<button type="submit" class="btn btn-secondary btn-sm">ADD INTERN</button>
					  </div>
					</form>
				  </div>
				</div>
			  </div>
		<!-- End Modal Add Student List  -->

        <!-- Modal Edit Student List -->
		<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modaladdspv" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered cascading-modal modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title" id="modaladdspv">Edit Internship</h5>
				  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				  </button>
				</div>
				...
				<form>
				  <div class="modal-body">
					<div class="form-group">
					  <label for="id_user">Student ID</label>
					  <input type="text" class="form-control" id="id_user" aria-describedby="id_user" placeholder="" required>
					</div>
					<div class="form-group">
						<label for="user_fullname">Full Name</label>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="studyprogram" placeholder="" required>
					</div>
					<div class="form-group">
						<label for="studyprogram">Start Date</label>
						<input type="date" class="form-control" id="studyprogram" placeholder="" required>
                    ...
                    <div class="form-group">
                          ...
                          <select class="form-control">
                            <option></option>
                            <option>Metta Santiputri</option>
                            <option>Supardianto</option>
                            <option>Hamdani</option>
                            <option>Dodi Prima Resda</option>
                          </select>
                    </div>
				  </div>
				  <div class="modal-footer border-top-0 d-flex justify-content-center">
