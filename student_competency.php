				...
				<!--Tampilan View Data-->
					...
					<?php
						...
						<!--Insert Data-->
							...
							<form action="proses_dummy_test.php?PageAction=add_student_competency" method="post">
								...
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<input type="date" class="form-control" name="catatan_utk_mahasiswa" id="catatan_utk_mahasiswa" required></input>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<p><b>End Date</b><span class="required-label">*</span> :</p>
											<input type="date" class="form-control" name="catatan_utk_poltek" id="catatan_utk_poltek" required></input>
										</div>
                                </div>
								</div><!-- Row -->
									...
									<div class="col-sm-12">
										...
										<table class="table table-bordered">
											...
											<tbody>
                                                ...
                                                include 'config.php';
												error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                                                $view = mysqli_query($conn, "SELECT * from (tb_profile_detail_comp LEFT JOIN tb_profile_jobdesc ON tb_profile_jobdesc.id_profile_jobdesc = tb_profile_detail_comp.id_profile_jobdesc) 
												LEFT JOIN tb_profile_detail_unit ON tb_profile_detail_unit.id_detail_profile = tb_profile_detail_comp.id_detail_profile 
												WHERE tb_profile_jobdesc.id_profile_jobdesc = '$_GET[id_profile_jobdesc]' GROUP BY tb_profile_detail_unit.id_detail_profile
												HAVING COUNT(tb_profile_detail_unit.id_detail_profile) >= 1");
												...
												<!-- <tr>
													<td>1.</td>
													<td><?php echo $data['unit_kompetensi']; ?></td>
													<td class="text-center">
														<input class="form-check-input ml-1" name="etika" value="4" type="radio">
													</td>
													<td class="text-center">
