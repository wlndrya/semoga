                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="attendance-datatables" class="display table table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        <th class="text-desc"><center>Week</center></th>
                                                        <th class="text-desc"><center>Date</center></th>
                                                        <th class="text-desc"><center>Check In</center></th>
                                                        <th class="text-desc"><center>Check Out</center></th>
														<th class="text-desc"><center>Description</center></th>
                                                        <th class="text-desc"><center>Type Attendance</center></th>
														<th class="text-desc" style="width: 10px;">
