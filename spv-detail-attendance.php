									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
												<a style="text-decoration: none !important" href="index.php?page=spv-detail2-attendance&id=<?= $data['id_internship']?>&week=<?= $data['week'] ?>" title="Details" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
