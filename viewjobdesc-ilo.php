                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-bordered" style="margin-top: -20px;">
                                            ...
                                            <form>
                                                <tbody>
                                                    ...
                                                    // echo $id_jobdesc;
                                                    $query = mysqli_query($conn, "SELECT * FROM (tb_detail_jobdesc LEFT JOIN tb_jobdesc ON tb_detail_jobdesc.id_jobdesc = tb_jobdesc.id_jobdesc) LEFT JOIN tb_ceklis_jobdesc_intern ON tb_ceklis_jobdesc_intern.id_detail = tb_detail_jobdesc.id_detail WHERE tb_ceklis_jobdesc_intern.id_jobdesc_intern = $id_jobdesc_intern");
                                                    if(!$query){
                                                        echo $conn->err;
                                                    }
                                        ...
                                        //print_r($id_jobdesc);
                                        $query = mysqli_query($conn, "SELECT * FROM tb_jobdesc INNER JOIN tb_jobdesc_intern ON tb_jobdesc_intern.id_jobdesc = tb_jobdesc.id_jobdesc WHERE tb_jobdesc_intern.id_jobdesc_intern = $id_jobdesc_intern;");
